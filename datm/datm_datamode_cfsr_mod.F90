...
!===============================================================================
  ...
  subroutine datm_datamode_cfsr_advertise(exportState, fldsexport, &
    ...
    !call dshr_fldList_add(fldsExport, 'Dusfc'  )

    call dshr_fldList_add(fldsExport, 'Faxa_tauy'  )
    !call dshr_fldList_add(fldsExport, 'Dvsfc'  )

    call dshr_fldList_add(fldsExport, 'Sa_z'       )
    !call dshr_fldList_add(fldsExport, 'Zlowest'       )

    call dshr_fldList_add(fldsExport, 'Sa_tbot'    )
    !call dshr_fldList_add(fldsExport, 'Tlowest'    )

    call dshr_fldList_add(fldsExport, 'Sa_shum'    )
    !call dshr_fldList_add(fldsExport, 'Qlowest'    )

    call dshr_fldList_add(fldsExport, 'Sa_u'       )
    !call dshr_fldList_add(fldsExport, 'Ulowest'       )

    call dshr_fldList_add(fldsExport, 'Sa_v'       )
    !call dshr_fldList_add(fldsExport, 'Vlowest'       )

    call dshr_fldList_add(fldsExport, 'Sa_pbot'    )
    !call dshr_fldList_add(fldsExport, 'Plowest'    )
! not in NEMSdatm
    call dshr_fldList_add(fldsExport, 'Sa_ptem'    )
! only in NEMSdatm
    !call dshr_fldList_add(fldsExport, 'T2m'    )
    !call dshr_fldList_add(fldsExport, 'Q2m'    )
    !call dshr_fldList_add(fldsExport, 'U10m'    )
    !call dshr_fldList_add(fldsExport, 'V10m'    )

! not in NEMSdatm
    !call dshr_fldList_add(fldsExport, 'Faxa_swnet' )
    !call dshr_fldList_add(fldsExport, 'Faxa_swdn'  )
    !call dshr_fldList_add(fldsExport, 'Dswrf' )

    call dshr_fldList_add(fldsExport, 'Faxa_lwdn'  )
    !call dshr_fldList_add(fldsExport, 'Dlwrf' )

! only in NEMSdatm
    !call dshr_fldList_add(fldsExport, 'Ulwrf' )

    call dshr_fldList_add(fldsExport, 'Faxa_lwnet'  )
    !call dshr_fldList_add(fldsExport, 'Nlwrf'  )

    call dshr_fldList_add(fldsExport, 'Faxa_sen'   )
    !call dshr_fldList_add(fldsExport, 'Shtfl'   )

    call dshr_fldList_add(fldsExport, 'Faxa_lat'   )
    !call dshr_fldList_add(fldsExport, 'Lhtfl'   )
    ...
    !call dshr_fldList_add(fldsExport, 'Ndbsf' )
    !call dshr_fldList_add(fldsExport, 'Nddsf' )
    !call dshr_fldList_add(fldsExport, 'Vbdsf' )
    !call dshr_fldList_add(fldsExport, 'Vddsf' )
...
!not in NEMSdatm
    ...
    !call dshr_fldList_add(fldsExport, 'Psurf'    )
...
!not in NEMSdatm
    ...
    !call dshr_fldList_add(fldsExport, 'Prate'  )
